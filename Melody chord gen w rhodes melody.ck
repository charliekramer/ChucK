...
for (0 => int i; true; i++)
{
    if (i%4 == 0) rhodeschord (60-12,0,beattime*4);
    if (i%4 == 0) rhodeschord (60-12,1,beattime*4/3);
    if (i%4 == 0) rhodeschord (60-12,2,beattime*4/3);
    if (i%4 == 0) rhodeschord (60-12,3,beattime*4/3);
