...
Gain master;
.001/(n*n)*.5*.5*.5*.5*.5*.5*.5 => master.gain;
...
.9 => rev.mix; 
1 => int loop; // choose whether to loop buf
.5 => float rate; // change rate of playback
0 => int randRate; // randomize playback rate

9 => float beatSec; // 2/4, 3/2 and 2/3 are interesting
