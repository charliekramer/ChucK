...
SinOsc kick => ADSR env => PitShift pit => HPF filt => Dyno dyn => dac;
...
class SnareDrum {
	...
	SinOsc snareSin => ADSR env => PitShift pit =>  Dyno dyn => dac;
	Noise snareNoise => ADSR envNoise => PitShift pitNoise => HPF filt => Dyno dynNoise => dac;
