...
// reverb, echo
// v3; new file (literal translation); flute; slower cadence (.15 second * 10)
//drumbeat; 60/600*6

//30::second => now; // pause to allow time to start video

1 => int n; // number of notes in chord

1./n*1.0 => float gainSet;

.15::second*10 => dur beat; // was 8
