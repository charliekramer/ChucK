...
MAUI_Slider slider1;
"Carrier Frequency (X)" => slider1.name;
//slider1.display();
slider1.range( 1, 127 );
...
MAUI_Slider slider2;
"Modulator Frequency (Y)" => slider2.name;
//slider2.display();
...
0 => int device; // may need to change this
...
//	<<< msg.data1, msg.data2, msg.data3>>>;
	...
	if( msg.data1 == 128 ) 
	{
		msg.data2*4000./127. => slider3.value;
	...
	if (msg.data1 == 144 && msg.data2 == 46)
	{
		1 => button_1.state;
	}
	if (msg.data1 == 144 && msg.data2 == 35)
	{
		1 => button_3.state;
	}
}
